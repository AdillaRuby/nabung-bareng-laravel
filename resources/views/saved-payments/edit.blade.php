    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
            <div class="text-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Pembayaran Sudah Bayar</h1>
                <p class="text-gray-600">Perbarui detail pembayaran yang sudah dikonfirmasi</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <form action="{{ route('saved-payments.update', $savedPayment) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="date" name="transaction_date" id="transaction_date" value="{{ $savedPayment->transaction_date->format('Y-m-d') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" id="amount" step="0.01" min="0.01" value="{{ $savedPayment->amount }}"
                ...
                <div>
                    ...
                    <textarea name="note" id="note" rows="4"
                              ...
                              placeholder="Tambahkan catatan untuk pembayaran ini...">{{ $savedPayment->note }}</textarea>
                    @error('note')
                        <p class="mt-1 text-sm text-red-600 flex items-center">
                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <a href="{{ route('saved-payments.index') }}"
        ...
        <div class="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Perhatian Saat Mengedit</h3>
                    <p class="text-sm text-gray-700">Pastikan data yang diubah sudah benar dan sesuai dengan kondisi sebenarnya.</p>
                </div>
            </div>
        </div>
    </div>
