    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
            <div class="text-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Penarikan</h1>
                <p class="text-gray-600">Perbarui detail penarikan yang telah dilakukan</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <form action="{{ route('withdraws.update', $withdraw) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="date" name="transaction_date" id="transaction_date" value="{{ $withdraw->transaction_date->format('Y-m-d') }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" id="amount" step="0.01" min="0.01" value="{{ $withdraw->amount }}"
                ...
                <div>
                    ...
                    <textarea name="note" id="note" rows="4"
                              class="block w-full px-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-colors duration-200 bg-white text-gray-900 placeholder-gray-500 resize-none">{{ $withdraw->note }}</textarea>
                    @error('note')
                        <p class="mt-1 text-sm text-red-600 flex items-center">
                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        ...
        <div class="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Edit Penarikan</h3>
                    <p class="text-sm text-gray-700">Perubahan pada penarikan akan tersimpan dan tercatat dalam riwayat penarikan.</p>
                </div>
            </div>
        </div>
    </div>
