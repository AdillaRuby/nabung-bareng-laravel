    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
            <div class="text-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Bayar Nabung</h1>
                <p class="text-gray-600">Bayar via QRIS dan konfirmasi pembayaran</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8 text-center">
            <button id="showQrisModal" type="button"
                    class="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200 transform hover:scale-105">
        ...
        <!-- Form -->
        <div id="paymentForm" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hidden">
            <form action="{{ route('pending-payments.store') }}" method="POST" class="space-y-6">
                @csrf
        ...
        <div class="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 mb-1">Pembayaran Pending</h3>
                    <p class="text-sm text-gray-700">Pembayaran ini akan masuk ke kategori pending sampai dikonfirmasi sebagai pembayaran tersimpan.</p>
                </div>
            </div>
        </div>
    </div>
